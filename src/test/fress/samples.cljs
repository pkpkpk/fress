...
(def utf8-samples
  [{:tag? true
    :form "(->utf8 \"hello\")"
    :bytes [-17 -34 117 116 102 56 2 5 104 101 108 108 111]
    :ubytes [239 222 117 116 102 56 2 5 104 101 108 108 111],
    :value "hello"}
   {:tag? true
    :form "(->utf8 \"😉 😎 🤔 😐 🙄\")"
    :bytes [-17 -34 117 116 102 56 2 24 -16 -97 -104 -119 32 -16 -97 -104 -114 32 -16 -97 -92 -108 32 -16 -97 -104 -112 32 -16 -97 -103 -124]
    :ubytes [239 222 117 116 102 56 2 24 240 159 152 137 32 240 159 152 142 32 240 159 164 148 32 240 159 152 144 32 240 159 153 132]
    :value "😉 😎 🤔 😐 🙄"}
   {:tag? false
    :form "(->utf8 \"hello\")"
    :bytes [-65 5 104 101 108 108 111]
    :ubytes [191 5 104 101 108 108 111],
    :value "hello"}
   {:tag? false
    :form "(->utf8 \"😉 😎 🤔 😐 🙄\")"
    :bytes [-65 24 -16 -97 -104 -119 32 -16 -97 -104 -114 32 -16 -97 -92 -108 32 -16 -97 -104 -112 32 -16 -97 -103 -124]
    :ubytes [191 24 240 159 152 137 32 240 159 152 142 32 240 159 164 148 32 240 159 152 144 32 240 159 153 132]
    :value "😉 😎 🤔 😐 🙄"}
   {:form "(->utf8 \"I'm a reasonable man, get off my case\")",
    ...
    :footer false
    :ubytes [239 222 117 116 102 56 2 37 73 39 109 32 97 32 114 101 97 115 111 110 97 98 108 101 32 109 97 110 44 32 103 101 116 32 111 102 102 32 109 121 32 99 97 115 101]
    :tag? true
    ...
    {:form "(->utf8 \"I'm a reasonable man, get off my case\")"
     ...
     :footer false
     :ubytes [191 37 73 39 109 32 97 32 114 101 97 115 111 110 97 98 108 101 32 109 97 110 44 32 103 101 116 32 111 102 102 32 109 121 32 99 97 115 101]
     :tag? false
     :value "I'm a reasonable man, get off my case"}])
